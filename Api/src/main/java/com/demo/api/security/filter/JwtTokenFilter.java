...
public class JwtTokenFilter extends OncePerRequestFilter {
    ...
    /* 제외할 url */
    private final List<String> excludedPatterns = Arrays.asList("/oauth/**", "/login/**", "/images/**", "/favicon.*", "/*/icon-*", "/auth/reissueToken");
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (authorizationHeader == null) {
            String accessToken = Optional.ofNullable(cookies)
                    ...
                    .orElse(null);
            if (accessToken != null) {
                validationAccessToken(request, response, filterChain, accessToken);
            } else {
...
//        }
    ...
    private void validationAccessToken(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain, String accessToken) throws IOException, ServletException {
        try {
            TokenStatus tokenStatus = jwtTokenProvider.validateToken(accessToken);
            /** accessToken */
            if (tokenStatus == TokenStatus.VALID) {
